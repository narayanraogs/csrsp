...
const file_communication_proto_rawDesc = "" +
	...
	"\x06dasMap\x18\x06 \x03(\v2\x18.Communication.AcqDASMapR\x06dasMap2\xe1\x03\n" +
	"\rCommunication\x12I\n" +
	...
	"\fGetDASStatus\x12\x1f.Communication.DASStatusRequest\x1a\x18.Communication.DASStatus0\x01B\x1cZ\x1acsrsp/server/communicationb\x06proto3"
...
var file_communication_proto_depIdxs = []int32{
	...
	0,  // 3: Communication.Communication.GetServerStatus:input_type -> Communication.ClientID
	0,  // 4: Communication.Communication.IsWhitelisted:input_type -> Communication.ClientID
	0,  // 5: Communication.Communication.GetServerDetails:input_type -> Communication.ClientID
	4,  // 6: Communication.Communication.Login:input_type -> Communication.LoginRequest
	0,  // 7: Communication.Communication.GetAcquisitionParameters:input_type -> Communication.ClientID
	10, // 8: Communication.Communication.GetDASStatus:input_type -> Communication.DASStatusRequest
	1,  // 9: Communication.Communication.GetServerStatus:output_type -> Communication.ServerStatus
	2,  // 10: Communication.Communication.IsWhitelisted:output_type -> Communication.IsWhitelistedResponse
	3,  // 11: Communication.Communication.GetServerDetails:output_type -> Communication.ServerDetails
	5,  // 12: Communication.Communication.Login:output_type -> Communication.LoginResponse
	11, // 13: Communication.Communication.GetAcquisitionParameters:output_type -> Communication.AcquisitionParameters
	8,  // 14: Communication.Communication.GetDASStatus:output_type -> Communication.DASStatus
